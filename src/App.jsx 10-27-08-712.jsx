  ...
  const act = {
    ...
    ejecutarCorrida: (id, ejecutadoPor) => {
      setSt((prev) => {
        ...
        const nuevosMovimientos = [...(prev.movimientos || [])];
        const nuevosBancos = [...(prev.bancos || [])];
        const tasaHoy = Number(prev.config.tasaBCV) || 1;
        ...
        (prev.compromisos || [])
          ...
          .forEach((c) => {
            ...
            // la tasa BCV de hoy, igual que el pago individual manual.
            const montoBs = c.moneda === "BS" ? Number(c.montoOriginal) : Number(c.montoOriginal) * tasaHoy;
            ...
            nuevosMovimientos.push({
              ...
              monto: montoBs,
              moneda: "BS",
              tasaBcvPago: c.moneda === "BS" ? null : tasaHoy,
